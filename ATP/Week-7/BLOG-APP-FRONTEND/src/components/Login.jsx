  ...
  useEffect(() => {
    ...
    if (isAuthenticated === true) {
      if (currentUser.role === "USER") {
        toast.success("Login success and redircting to User profile",{duration:3000})
        navigate("/user-profile");
      }
      if (currentUser.role === "AUTHOR") {
        toast.success("Login success and redircting to Author profile",{duration:3000})
        navigate("/author-profile");
      }
      if (currentUser.role === "ADMIN") {
        toast.success("Login success and redircting to Admin profile",{duration:3000})
